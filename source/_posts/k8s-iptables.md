---
title: k8s iptables 规则查看
date: 2018-11-29 11:24:30
categories: PaaS
tags: [k8s]
---

在访问 k8s 服务时，有时会出现一直连不上的问题，我们可以通过分析 iptables 和抓包的方式观察报文是否正确到达。关于 iptable 的介绍可以参考：[iptables](../../../../2018/06/29/iptables/)
